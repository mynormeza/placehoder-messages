...
class TogglePostFavoriteUseCase @Inject constructor(private val postsRepository: IPostRepository) : UseCase<None, Post>() {
    override suspend fun run(params: Post): Either<Failure, None> {
